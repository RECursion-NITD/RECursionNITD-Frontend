...
import "./index.css"; // Ensure this is included to use Tailwind CSS
import Home from "./components/Home";
import ExperimentalHome from "./components/ExperimentalHome";
import Login from "./components/Login";
import Layout from "./components/Layout";
        ...
        <Routes>
          <Route path="/" element={<Layout />}>
            ...
            <Route element={<RequireAuth />}>
              ...
              <Route path="blog" element={<Blog />} />
              <Route path="experience" element={<Experiences />} />
              <Route path="experience/detail/:experienceId" element={<DetailedExperiencePage />} />
              <Route path="experience/add" element={<PostExperience />} />
              <Route element={<RequireMember />}>
                <Route path="events/create" element={<CreateEvent />} />
              </Route>
            </Route>
            <Route path="events/detail/:eventId" element={<DetailEvent />} />
          </Route>
          <Route path="*" element={<NotFound />} />
        </Routes>
      </AuthProvider>
